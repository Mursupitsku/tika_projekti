...
tilauspvm DATE NOT NULL DEFAULT CURRENT_DATE,  -- NOT NULL !?
...
toimituspvm DATE NOT NULL DEFAULT CURRENT_DATE,   -- NOT NULL !?
...
nimi VARCHAR(60) NOT NULL,                  -- MUUTETTU,
tekija VARCHAR(25),                         -- MUUTETTU,
vuosi INT,
isbn VARCHAR(15),
paino INT NOT NULL
);
